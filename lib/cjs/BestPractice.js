...
class BestPractice {
    ...
    getMeta(key, joiner = '\n') {
        var _a;
        return (_a = this.meta[key]) === null || _a === void 0 ? void 0 : _a.join(joiner);
    }
    getTitle() {
    ...
    compare(other) {
        var _a, _b, _c, _d;
        const leftTitle = toPathSafeString((_a = this.getTitle()) !== null && _a !== void 0 ? _a : '');
        const rightTitle = toPathSafeString((_b = other.getTitle()) !== null && _b !== void 0 ? _b : '');
        const value = leftTitle.localeCompare(rightTitle);
        if (value !== 0) {
            return value;
        }
        const leftSubtitle = toPathSafeString((_c = this.getSubtitle()) !== null && _c !== void 0 ? _c : '');
        const rightSubtitle = toPathSafeString((_d = other.getSubtitle()) !== null && _d !== void 0 ? _d : '');
    ...
    parseLine(lineNumber, line) {
        ...
        if (isStartLine(line)) {
            ...
            if (this.getState() === 'CODE') {
                ...
                if (context) {
                    this.meta[context].push(((_a = getMeta(line)) !== null && _a !== void 0 ? _a : '').trim());
                }
            }
        }
        else {
